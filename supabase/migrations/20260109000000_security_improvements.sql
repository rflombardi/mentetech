...
COMMENT ON TABLE public.posts IS
  'Blog posts table. Public read access for published posts only. All modifications restricted to admins.';

COMMENT ON TABLE public.categorias IS
  'Blog categories table. Public read access. All modifications restricted to admins.';
